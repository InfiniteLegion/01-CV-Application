        ...
        <section className="experience-information">
            ...
            <div className="forms-block">
                {forms.map((form, index) => (
                    <div key={form.id}>
                        <FormExperienceInformation index={index} id={form.id} deleteForm={handleRemoveForm} />
                    </div>
                ))}

                <div className="btn-block">
                    <button className="form-btn" onClick={() => handleChangePage(1)}>&larr; Previous</button>
                    <button className="form-btn" onClick={handleAddForm}>Add experience</button>
